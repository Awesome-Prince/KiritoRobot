...
from KiritoRobot.plugins.helpers.nightmode_helper import (
    add_nightmode,
    get_all_chat_id,
    is_nightmode_indb,
    rmnightmode,
...
NI_MODE = """
**🎮 An Powerful Elemnt To Keep Your Group Safe From Night Raids!**

➛ `/nimode on/off` - To Lock Your Group On Night Times.
